...
def parse_args():
    ...
    parser.add_argument("--angRes_out", type=int, default=8, help="output angular resolution")
    # parser.add_argument("--model_name", type=str, default='EGPF_Lytro_2x2-7x7')
    ...
    parser.add_argument("--model_name", type=str, default='TransFreq_Lytro_2x2-8x8_extro0')
    # parser.add_argument("--testset_dir", type=str, default='../Data1/TestData_RE_HCI_2x2-7x7/')
    parser.add_argument("--testset_dir", type=str, default='../Data/TestData_RE_Lytro_2x2-8x8_extro0/')
...
def test(cfg):
    ...
    model = torch.load('./log/' + cfg.model_name + '.pth.tar', map_location={'cuda:1': cfg.device}, weights_only= True)
...
def valid(test_loader, test_name, net):
    ...
    for idx_iter, (data, label) in (enumerate(test_loader)):
        ...
        txtfile_0 = open(total_metrics_path + 'total_' + 'metrics.txt', 'a')
